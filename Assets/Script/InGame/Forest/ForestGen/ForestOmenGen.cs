...
{
    [Header("生成パラメータ")]
    [SerializeField, Range(0f, 1f)] private float floorSpawnChance = 0.05f; // 床上
    [SerializeField, Range(0f, 1f)] private float wallSpawnChance = 0.05f;  // 壁用
    [SerializeField, Range(0f, 1f)] private float beyondInLandSpawnChance = 0.8f;  // 壁外用
    [SerializeField, Range(0f, 1f)] private float beyondSpawnChance = 0.05f;  // 壁外用
